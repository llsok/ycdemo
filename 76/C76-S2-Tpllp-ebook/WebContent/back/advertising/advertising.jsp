...
<script type="text/javascript"
	src="<%=application.getContextPath()%>/back/Widget/swfupload/swfupload.js"></script>
<script type="text/javascript"
	src="<%=application.getContextPath()%>/back/Widget/swfupload/swfupload.queue.js"></script>
<script type="text/javascript"
	src="<%=application.getContextPath()%>/back/Widget/swfupload/swfupload.speed.js"></script>
<script type="text/javascript"
	src="<%=application.getContextPath()%>/back/Widget/swfupload/handlers.js"></script>
<title>广告管理</title>
</head>
	...
	<div class=" clearfix" id="advertising">
		...
		<div class="Ads_list">
			<div class="border clearfix">
				...
				</span> <span class="r_f">共：<b>5</b>条广告
				</span>
			</div>
			<div class="Ads_lists">
					...
					<tbody>
						<tr>
							...
							<td><span class="ad_img"><img
									src="<%=application.getContextPath()%>/back/products/ad.jpg"
									width="100%" height="100%" /></span></td>
							<td>1890x1080</td>
							<td><a href="<%=application.getContextPath()%>/back/#"
								target="_blank">http://item.jd.com/10443270082.html</a></td>
					...
					class="cont_style">
						<div class="demo">
							<div class="logobox">
								<div class="resizebox">
									<img
										src="<%=application.getContextPath()%>/back/images/image.png"
