...
<meta http-equiv="Cache-Control" content="no-siteapp" />
        ...
        <link rel="stylesheet" href="<%=application.getContextPath() %>/back/assets/css/colorbox.css"> 
         <!--图片相册-->   
        ...
        <script src="<%=application.getContextPath() %>/back/assets/js/jquery.colorbox-min.js"></script>
...
<div class="page-content clearfix">
 <div class="sort_adsadd_style">
  <div class="border clearfix">
       <span class="l_f">
        <a href="<%=application.getContextPath() %>/back/javascript:ovid()"  id="ads_add" title="添加品牌" class="btn btn-warning Order_form"><i class="fa fa-plus"></i> 添加广告</a>
        <a href="<%=application.getContextPath() %>/back/javascript:ovid()" class="btn btn-danger"><i class="fa fa-trash"></i> 批量删除</a>
        <a href="<%=application.getContextPath() %>/back/javascript:ovid()" onClick="javascript :history.back(-1);" class="btn btn-info"><i class="fa fa-reply"></i> 返回上一步</a>
       </span>
 ...
 <!--列表样式-->
	...
	<tbody>
      <tr>
       ...
       <td><span class="ad_img"><a href="<%=application.getContextPath() %>/back/products/ad.jpg" data-rel="colorbox" data-title="广告图"><img src="<%=application.getContextPath() %>/back/products/ad.jpg"  width="100%" height="100%"/></a></span></td>      
       <td>1890x1080</td>
      ...
      <tr>
       ...
       <td><span class="ad_img"><a href="<%=application.getContextPath() %>/back/products/ad1.jpg" data-rel="colorbox" data-title="广告图"><img src="<%=application.getContextPath() %>/back/products/ad1.jpg"  width="100%" height="100%"/></a></span></td>      
       <td>1890x1080</td>
       <td><a href="<%=application.getContextPath() %>/back/#" target="_blank">http://item.jd.com/10443270082.html</a></td>
       <td>2016-6-29 12:34</td>
       <td class="td-status"><span class="label label-success radius">显示</span></td>
      <td class="td-manage">
       ...
       <td>幻灯片</td>
        <td><input name="" type="text"  style=" width:50px" placeholder="2"/></td>
       <td><span class="ad_img"><a href="<%=application.getContextPath() %>/back/products/p_42.jpg" data-rel="colorbox" data-title="广告图"><img src="<%=application.getContextPath() %>/back/products/p_42.jpg"  width="100%" height="100%"/></a></span></td>      
       <td>1890x1080</td>
       <td><a href="<%=application.getContextPath() %>/back/#" target="_blank">http://item.jd.com/10443270082.html</a></td>
       <td>2016-6-29 12:34</td>
       <td class="td-status"><span class="label label-success radius">显示</span></td>
