...
<div class="clearfix">
 ...
 <div class="Ads_list">
    <div class="border clearfix">
       <span class="l_f">
        <a href="${path}/back/article_add.html"  title="添加文章" id="add_page" class="btn btn-warning"><i class="fa fa-plus"></i> 添加文章</a>
       ...
       <thead>
        ...
        <tbody>
         <tr>
          ...
          <td>显示</td>
          <td class="td-manage">   
           <a title="编辑" onclick="member_edit('编辑','member-add.html','4','','510')" href="${path}/back/javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
           <a title="删除" href="${path}/back/javascript:;"  onclick="member_del(this,'1')" class="btn btn-xs btn-danger" ><i class="fa fa-trash  bigger-120"></i></a>
          </td>
         </tr>
         <tr>
          <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
